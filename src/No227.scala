...
object No227 {
  /**
    * Because * and / and higher priority than + and -
    * If we encounter + or -, we push it into operator stack for later evaluation
    * Otherwise, we find the next operand and evaluate.
    */
